  ...
  projects: [
    {
      ...
      caseStudy: {
        ...
        execution: '• 11년 차 유튜브 전문가라는 강사의 강점을 살려 유튜브 알고리즘과 조회수 기반 수익화 노하우를 강사의 핵심 소구점으로 기획했습니다.\n• AI 음악 제작 프로그램 체험권을 제공하여 수강생이 콘텐츠를 직접 경험한 뒤 정규강의 결제를 결정할 수 있도록 학습 경험을 설계했습니다.',
    ...
    },
    {
      ...
      caseStudy: {
        ...
        background: '해외 예능을 쇼츠로 편집해 일본 시장에 업로드하는 콘텐츠였지만 영상 편집, 외국어 번역, 저작권 이슈 등으로 인해 수강생들이 높은 진입장벽을 느끼고 있었습니다.',
        ...
        results: '결제 전환율 11.8% 달성 (내부 평균 결제 전환율 대비 + 3.8%)',
    ...
    },
    {
      ...
      caseStudy: {
        ...
        results: '결제 전환율 9.4% 달성 (내부 평균 결제 전환율 대비 + 1.4%)\n강의 시작 이후 환불 0건',
    ...
    },
    {
      ...
      caseStudy: {
        ...
        results: '결제 전환율 17.2% 달성 (내부 평균 결제 전환율 대비 + 9.2%)',
